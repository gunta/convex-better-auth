...
export declare const createClient: <DataModel extends GenericDataModel, Schema extends SchemaDefinition<GenericSchema, true> = typeof defaultSchema, Api extends SlimComponentApi = SlimComponentApi>(component: Api, config?: {
     ...
     */
    adapter: (ctx: GenericCtx<DataModel>) => import("better-auth/adapters").AdapterFactory<import("better-auth").BetterAuthOptions>;
    /**
    ...
    registerRoutesLazy: <T extends CreateAuth<DataModel>>(http: HttpRouter, createAuth: T, opts?: RegisterRoutesLazyOptions) => void;
};
export {};
