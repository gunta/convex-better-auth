...
export declare const adapterWhereValidator: import("convex/values").VObject<{
    ...
    mode: import("convex/values").VUnion<"sensitive" | "insensitive" | undefined, [import("convex/values").VLiteral<"sensitive", "required">, import("convex/values").VLiteral<"insensitive", "required">], "optional", never>;
}, "required", "value" | "field" | "mode" | "operator" | "connector">;
export declare const adapterArgsValidator: import("convex/values").VObject<{
    ...
    where: import("convex/values").VArray<{
        ...
        connector: import("convex/values").VUnion<"AND" | "OR" | undefined, [import("convex/values").VLiteral<"AND", "required">, import("convex/values").VLiteral<"OR", "required">], "optional", never>;
        mode: import("convex/values").VUnion<"sensitive" | "insensitive" | undefined, [import("convex/values").VLiteral<"sensitive", "required">, import("convex/values").VLiteral<"insensitive", "required">], "optional", never>;
    }, "required", "value" | "field" | "mode" | "operator" | "connector">, "optional">;
...
}, "required", "limit" | "model" | "select" | "where" | "sortBy" | "offset" | "sortBy.field" | "sortBy.direction">;
export declare const hasUniqueFields: (betterAuthSchema: BetterAuthDBSchema, model: string, input: Record<string, any>) => boolean;
export declare const touchesUniqueFields: (betterAuthSchema: BetterAuthDBSchema, model: string, input: Record<string, any>) => boolean;
...
export declare const selectFields: <T extends TableNamesInDataModel<GenericDataModel>, D extends DocumentByName<GenericDataModel, T>>(doc: D | null, select?: string[]) => D | null;
