    ...
    return {
        ...
        hooks: {
            before: [
                {
                    matcher(ctx) {
                        return (Boolean(ctx.request?.headers.has("better-auth-cookie") ||
                            ctx.headers?.has("better-auth-cookie")) && !isExpoNative(ctx));
                    },
            ...
            after: [
                ...
                {
                    matcher: (ctx) => {
                        return Boolean((ctx.path?.startsWith("/callback") ||
